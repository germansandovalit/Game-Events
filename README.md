...
### 🧩 Mejoras Planeadas
- [ ] Actualizar el comando `!eventos` para mostrar una **tabla agrupando los eventos por nombre, en el caso que existan multiples, se muestra el mas proximo** con las siguientes columnas:  
